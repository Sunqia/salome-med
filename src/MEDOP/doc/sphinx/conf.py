...
templates_path = [os.path.join('/dn47/SALOME/series6xDEV/MED/Mandriva2010/MED_SRC/src/MEDOP/doc/sphinx','_templates')]
...
html_static_path = [os.path.join('/dn47/SALOME/series6xDEV/MED/Mandriva2010/MED_SRC/src/MEDOP/doc/sphinx','_static')]
