...
IF(BOOST_STATUS)
  IF(BOOST_ROOT_USER)
    MESSAGE(STATUS "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")
    SET(BOOST_LIB_PATHS ${BOOST_ROOT_USER}/stage/lib)
	MESSAGE(STATUS ${BOOST_LIB_PATHS})
  ELSE(BOOST_ROOT_USER)
    MESSAGE(STATUS "YYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYY")
    SET(BOOST_LIB_PATHS $ENV{BOOSTDIR}/stage/lib)
	MESSAGE(STATUS ${BOOST_LIB_PATHS})
  ENDIF(BOOST_ROOT_USER)
ENDIF(BOOST_STATUS)
...
IF(BOOST_STATUS)
  ...
  FOREACH(name thread date_time signals filesystem system regex)
    IF(WINDOWS)
      ...
      FOREACH(version 1_35 1_38 1_42 1_46_1 1_49 1_53)
        SET(LIB_NAMES ${LIB_NAMES} boost_${name}-vc100-mt${EXTENSION}-${version})
        SET(STATIC_LIB_NAMES ${STATIC_LIB_NAMES} libboost_${name}-vc100-mt${EXTENSION}-${version})
      ENDFOREACH(version 1_35 1_38 1_42 1_46_1 1_49 1_53)
